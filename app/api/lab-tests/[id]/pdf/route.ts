...
export async function GET(req: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    let org = { name: 'Dayspring Medical Center', logoUrl: '/logo.png', email: 'dayspringmedicalcenter@gmail.com', phone: '+256 703-942-230 / +256 703-844-396 / +256 742-918-253' } as any
