...
import { Activity, FileText, Clock, AlertCircle, Loader2, Pill, ListChecks, ArrowRightLeft } from "lucide-react"
import { TriageForm } from "@/components/patient/triage-form"
import { MARView } from "@/components/nursing/mar-view"
import { ProceduresView } from "@/components/nursing/procedures-view"
import { ReferralsView } from "@/components/patient/referrals-view"
...
type CareTab = "vitals" | "notes" | "history" | "triage" | "mar" | "procedures" | "referrals"
...
export function PatientCareView({ patientId, onBack, initialTab = "vitals", onUpdated }: PatientCareViewProps) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (saved && ["vitals", "notes", "history", "triage", "procedures", "referrals", "mar"].includes(saved)) setActiveTab(saved as CareTab)
    } catch {}
  ...
  const TABS: { value: CareTab; label: string; Icon: typeof Activity }[] = [
    ...
    { value: "procedures", label: "Procedures", Icon: ListChecks },
    ...
    <div className="flex flex-col">
      ...
      <div className="p-6">
        ...
        {activeTab === "procedures" && (
          <div className="mt-4">
            <ProceduresView patientId={patientId} />
          </div>
        )}
        ...
        {activeTab === "referrals" && (
          <div className="mt-4">
            <ReferralsView patientId={patientId} />
          </div>
        )}
