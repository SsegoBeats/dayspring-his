...
interface PatientCareListProps {
  onSelectPatient: (patientId: string, tab?: "vitals" | "notes" | "history" | "triage" | "procedures" | "referrals") => void
}
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <Button
                            ...
                            onClick={() => onSelectPatient(patient.id, "procedures")}
                          >
                            Procedures
                          </Button>
                          <Button
                            ...
                            onClick={() => onSelectPatient(patient.id, "referrals")}
                          >
                            Referrals
                          </Button>
                          <Button
