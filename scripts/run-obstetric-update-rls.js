/**
 * Run obstetric assessments UPDATE RLS migration (0018).
 * Usage: node scripts/run-obstetric-update-rls.js
...
const MIGRATION = "0018_obstetric_assessments_update_rls.sql";
